...
#
# Copyright (C) 2020-2021 hey <hyyoxhk@163.com>
#
...
#quiet_cmd_bl2__ = LD      $@
#      cmd_bl2__ = $(CC) $(LDFLAGS) -o $@                          \
#      -Wl,--start-group $(bl2-init) $(bl2-main) -Wl,--end-group
...
# All the preparing..
#prepare: outputmakefile scripts_basic FORCE
#	$(Q)$(MAKE) $(build)=.
